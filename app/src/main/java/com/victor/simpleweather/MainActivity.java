...
import com.victor.simpleweather.Adapters.FiveDaysWeatherAdapter;
import com.victor.simpleweather.Adapters.TodaysWeatherAdapter;
import com.victor.simpleweather.Models.FiveDays;
import com.victor.simpleweather.Models.MyLocation;
import com.victor.simpleweather.Models.OneDay;
import com.victor.simpleweather.Models.ThreeHours;
import com.victor.simpleweather.Tasks.MyLocationTask;
import com.victor.simpleweather.Tasks.MyLocationTaskListener;
import com.victor.simpleweather.Tasks.MyWeatherTask;
import com.victor.simpleweather.Tasks.MyWeatherTaskListener;
...
public class MainActivity extends AppCompatActivity implements MyLocationTaskListener, MyWeatherTaskListener {
    ...
    String mAPIKey = "d3c7dbcd5b273500e261b6ca439bcdb5";
    ...
    private void initializeComponents() {
        ...
        menuIndex = 1; //Used for adding menu items, reason it starts with 1 is because index 0 is reserved for "Manage Favorite Locations" item
    ...
    private void setListeners() {
        navigationView.setNavigationItemSelectedListener(item -> {
            if (item.getTitle().equals("Manage Favorite Locations")) {
    ...
    private void getLocationFromSearch() {
        ...
        new MyLocationTask((MyLocationTaskListener) this).execute(myURL);
    }

    @Override
    public void onMyLocationTaskPreExecute() {
    }//Left Empty
    ...
    //get the user's current coordinates (latitude and longitude)
    ...
    private void loadWeatherData() {
        ...
        new MyWeatherTask((MyWeatherTaskListener) this).execute(weatherURL);
    }
    ...
    public void onMyWeatherTaskPostExecute(FiveDays fiveDays) {
        if (fiveDays != null) {
            ...
            tvRainPercentage.setText(Integer.toString(temp * 100) + "% rain");
